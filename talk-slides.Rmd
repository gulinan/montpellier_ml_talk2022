...
# Example re-visited
<br>
- The <b><span style="color:#067373;">naive CV intervals</span></b> for **three estimands**: $Err$, $Err_{X}$, and $Err_{XY}$ are built and miscoverage rates are estimated.
- The naive CV intervals **fail** due to larger miscoverage rates (or small confidence intervals).
